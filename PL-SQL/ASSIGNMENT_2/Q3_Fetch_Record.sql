-- SET SERVEROUTPUT ON;
-- @ E:\BARAIYA_ANIL\ASSIGNMENT_2\Q3_Fetch_Record.sqls
DECLARE
    CURSOR myCursor IS SELECT * FROM employee;
...
-- BEGIN
--     FOR rec IN (SELECT empNo, empName, salary FROM employee) LOOP
--         DBMS_OUTPUT.PUT_LINE(
--             rec.empNo || '   ' || rec.empName || '   ' || rec.salary
--         );
--     END LOOP;
-- END;
-- /
